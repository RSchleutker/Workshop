...
qPCRAmplification <- read_csv("../Exercises/qPCR/Amplification.csv", trim_ws = TRUE)

ggplot(qPCRAmplification, aes(Cycle, dRn, group = `Target Name`, colour = `Target Name`)) +
  geom_line() +
  geom_hline(yintercept = 0.15) +
  scale_y_continuous(name = expression(Delta*"Rn"), trans = "log10", labels = comma) +
  scale_color_discrete(labels = c("GAPDH (e2i2)", "GAPDH (e3i3)", "GAPDH (e4i4)", "p21 (e2i2)", "RPL3 (e9e10)"))
```
...
>- Daten von den Dateinamen verwenden.
>- Für jede Spalte in einer Tabelle gleichzeitig Mittelwert und andere deskreptive Werte berechnen.