...
Die Daten bestehen aus 15 Dateien, welche sich im Unterordner *./Data/* befinden. Der Name jeder Datei setzt sich aus der untersuchten Spezies, der jeweiligen Vogel-ID, der Messnummer, sowie einer Spezifizierung der Daten zusammen - jeweils durch ein _ getrennt. In dieser Analyse wurden lediglich die **Lines**-Daten untersucht.
...
```{r}
readr::read_csv("./Data/Canary_ID1_805_Lines.csv", comment = "#", skip = 1)
```
